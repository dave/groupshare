...
func (Op_root_type) Bar() Bar_type {
	return Bar_type{}
}
...
func (b Bar_type) Location_get() []*delta.Locator {
	return b.location
}
func NewBar_type(l []*delta.Locator) Bar_type {
	return Bar_type{location: l}
}
func (b Bar_type) Name() delta.String_scalar {
	return delta.NewString_scalar(delta.CopyAndAppendField(b.location, "name", 1))
}
func (b Bar_type) Delete() *delta.Op {
	return delta.Delete(b.location)
}
func (b Bar_type) Set(value *Bar) *delta.Op {
	return delta.Set(b.location, value)
}

type Bar_type_list struct {
	location []*delta.Locator
}

func (b Bar_type_list) Location_get() []*delta.Locator {
	return b.location
}
func NewBar_type_list(l []*delta.Locator) Bar_type_list {
	return Bar_type_list{location: l}
}
func (b Bar_type_list) Index(i int) Bar_type {
	return NewBar_type(delta.CopyAndAppendIndex(b.location, int64(i)))
}
func (b Bar_type_list) Insert(index int, value *Bar) *delta.Op {
	return delta.Insert(delta.CopyAndAppendIndex(b.location, int64(index)), value)
}
func (b Bar_type_list) Move(from, to int) *delta.Op {
	return delta.Move(delta.CopyAndAppendIndex(b.location, int64(from)), int64(to))
}
func (b Bar_type_list) Delete() *delta.Op {
	return delta.Delete(b.location)
}
func (b Bar_type_list) Set(value []*Bar) *delta.Op {
	return delta.Set(b.location, value)
}

type Bar_type_bool_map struct {
	location []*delta.Locator
}

func (b Bar_type_bool_map) Location_get() []*delta.Locator {
	return b.location
}
func NewBar_type_bool_map(l []*delta.Locator) Bar_type_bool_map {
	return Bar_type_bool_map{location: l}
}
func (b Bar_type_bool_map) Key(key bool) Bar_type {
	return NewBar_type(delta.CopyAndAppendKeyBool(b.location, key))
}
func (b Bar_type_bool_map) Rename(from, to bool) *delta.Op {
	return delta.Rename(delta.CopyAndAppendKeyBool(b.location, from), to)
}
func (b Bar_type_bool_map) Delete() *delta.Op {
	return delta.Delete(b.location)
}
func (b Bar_type_bool_map) Set(value map[bool]*Bar) *delta.Op {
	return delta.Set(b.location, value)
}

type Bar_type_int32_map struct {
	location []*delta.Locator
}

func (b Bar_type_int32_map) Location_get() []*delta.Locator {
	return b.location
}
func NewBar_type_int32_map(l []*delta.Locator) Bar_type_int32_map {
	return Bar_type_int32_map{location: l}
}
func (b Bar_type_int32_map) Key(key int) Bar_type {
	return NewBar_type(delta.CopyAndAppendKeyInt32(b.location, int32(key)))
}
func (b Bar_type_int32_map) Rename(from, to int) *delta.Op {
	return delta.Rename(delta.CopyAndAppendKeyInt32(b.location, int32(from)), int32(to))
}
func (b Bar_type_int32_map) Delete() *delta.Op {
	return delta.Delete(b.location)
}
func (b Bar_type_int32_map) Set(value map[int32]*Bar) *delta.Op {
	return delta.Set(b.location, value)
}

type Bar_type_int64_map struct {
	location []*delta.Locator
}

func (b Bar_type_int64_map) Location_get() []*delta.Locator {
	return b.location
}
func NewBar_type_int64_map(l []*delta.Locator) Bar_type_int64_map {
	return Bar_type_int64_map{location: l}
}
func (b Bar_type_int64_map) Key(key int) Bar_type {
	return NewBar_type(delta.CopyAndAppendKeyInt64(b.location, int64(key)))
}
func (b Bar_type_int64_map) Rename(from, to int) *delta.Op {
	return delta.Rename(delta.CopyAndAppendKeyInt64(b.location, int64(from)), int64(to))
}
func (b Bar_type_int64_map) Delete() *delta.Op {
	return delta.Delete(b.location)
}
func (b Bar_type_int64_map) Set(value map[int64]*Bar) *delta.Op {
	return delta.Set(b.location, value)
}

type Bar_type_uint32_map struct {
	location []*delta.Locator
}

func (b Bar_type_uint32_map) Location_get() []*delta.Locator {
	return b.location
}
func NewBar_type_uint32_map(l []*delta.Locator) Bar_type_uint32_map {
	return Bar_type_uint32_map{location: l}
}
func (b Bar_type_uint32_map) Key(key int) Bar_type {
	return NewBar_type(delta.CopyAndAppendKeyUint32(b.location, uint32(key)))
}
func (b Bar_type_uint32_map) Rename(from, to int) *delta.Op {
	return delta.Rename(delta.CopyAndAppendKeyUint32(b.location, uint32(from)), uint32(to))
}
func (b Bar_type_uint32_map) Delete() *delta.Op {
	return delta.Delete(b.location)
}
func (b Bar_type_uint32_map) Set(value map[uint32]*Bar) *delta.Op {
	return delta.Set(b.location, value)
}

type Bar_type_uint64_map struct {
	location []*delta.Locator
}

func (b Bar_type_uint64_map) Location_get() []*delta.Locator {
	return b.location
}
func NewBar_type_uint64_map(l []*delta.Locator) Bar_type_uint64_map {
	return Bar_type_uint64_map{location: l}
}
func (b Bar_type_uint64_map) Key(key int) Bar_type {
	return NewBar_type(delta.CopyAndAppendKeyUint64(b.location, uint64(key)))
}
func (b Bar_type_uint64_map) Rename(from, to int) *delta.Op {
	return delta.Rename(delta.CopyAndAppendKeyUint64(b.location, uint64(from)), uint64(to))
}
func (b Bar_type_uint64_map) Delete() *delta.Op {
	return delta.Delete(b.location)
}
func (b Bar_type_uint64_map) Set(value map[uint64]*Bar) *delta.Op {
	return delta.Set(b.location, value)
}

type Bar_type_string_map struct {
	location []*delta.Locator
}

func (b Bar_type_string_map) Location_get() []*delta.Locator {
	return b.location
}
func NewBar_type_string_map(l []*delta.Locator) Bar_type_string_map {
	return Bar_type_string_map{location: l}
}
func (b Bar_type_string_map) Key(key string) Bar_type {
	return NewBar_type(delta.CopyAndAppendKeyString(b.location, key))
}
func (b Bar_type_string_map) Rename(from, to string) *delta.Op {
	return delta.Rename(delta.CopyAndAppendKeyString(b.location, from), to)
}
func (b Bar_type_string_map) Delete() *delta.Op {
	return delta.Delete(b.location)
}
func (b Bar_type_string_map) Set(value map[string]*Bar) *delta.Op {
	return delta.Set(b.location, value)
}
