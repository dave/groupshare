...
const Change$json = const {
  '1': 'Change',
  '2': const [
    const {'1': 'type', '3': 1, '4': 1, '5': 14, '6': '.changepb.Change.Type', '10': 'type'},
    const {'1': 'location', '3': 2, '4': 3, '5': 11, '6': '.changepb.Locator', '10': 'location'},
    const {'1': 'value', '3': 3, '4': 1, '5': 11, '6': '.google.protobuf.Any', '10': 'value'},
  ],
  '4': const [Change_Type$json],
};

const Change_Type$json = const {
  '1': 'Type',
  '2': const [
...
const Locator$json = const {
  '1': 'Locator',
  '2': const [
    const {'1': 'field', '3': 1, '4': 1, '5': 11, '6': '.changepb.Field', '9': 0, '10': 'field'},
