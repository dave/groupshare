...
const Share_Get_Response$json = const {
  ...
  '2': const [
    ...
    const {'1': 'share', '3': 2, '4': 1, '5': 11, '6': '.messages.Share', '10': 'share'},
  ],
};
...
const Share_Add_Request$json = const {
  '1': 'Request',
  '2': const [
    const {'1': 'share', '3': 1, '4': 1, '5': 11, '6': '.messages.Share', '10': 'share'},
  ],
};
...
const Share_Edit_Request$json = const {
  ...
  '2': const [
    const {'1': 'id', '3': 1, '4': 1, '5': 9, '10': 'id'},
    const {'1': 'version', '3': 2, '4': 1, '5': 9, '10': 'version'},
    const {'1': 'deltas', '3': 3, '4': 3, '5': 11, '6': '.delta.Delta', '10': 'deltas'},
  ],
};
