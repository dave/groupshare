...
class State_Item extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('State.Item', package: const $pb.PackageName('messages'), createEmptyInstance: create)
    ..aOS(1, 'type')
    ..aOS(2, 'id')
    ..aInt64(3, 'state')
    ..aOS(5, 'unique')
  ...
  factory State_Item.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory State_Item.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  State_Item clone() => State_Item()..mergeFromMessage(this);
  State_Item copyWith(void Function(State_Item) updates) => super.copyWith((message) => updates(message as State_Item));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static State_Item getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<State_Item>(create);
  ...
  @$pb.TagNumber(5)
  set unique($core.String v) { $_setString(3, v); }
  @$pb.TagNumber(5)
